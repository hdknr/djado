========================================================================
** Djado ** Installation Instructions
========================================================================

This section contains information about 
how to download and install **Djado** in your system. 
...
To install **Djado** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/djado.git#egg=djado

The above command will install the latest development release of **Djado**.
